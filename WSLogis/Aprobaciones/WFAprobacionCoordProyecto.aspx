<%@ Page Title="Aprobacion Coord. Proyecto" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WFAprobacionCoordProyecto.aspx.cs" Inherits="WSLogis.Aprobaciones.WFAprobacionCoordProyecto" %>
                        ...
                        <tr>
                            <td colspan="4" style="text-align: center;">
                                <div style="background-color: #FFCC00; height: 28px;">
                                    <h2>Aprobacion Coord. Proyecto </h2>
                                </div>
                            </td>
